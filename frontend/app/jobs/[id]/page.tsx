                ...
                {cvListLoading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-600 rounded-xl p-5 cursor-pointer hover:border-blue-500 hover:bg-blue-500/5 transition-all group">
                        <input
                          type="file"
                          accept=".pdf"
                          className="hidden"
